package bg.sofia.uni.fmi.mjt.w3.argumentpassing.records;
...
public record Student(String name, int facultyNumber) {
    ...
    // The code in the compact constructor is inserted by the compiler in the beginning of the definition of the canonical one.
