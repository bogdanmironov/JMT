...
public class SlowPerformanceExample {
    ...
    public static long testBankAccount(BankAccount bankAccount) throws Exception {
        // Gets the current time in the beginning
...
class SlowPrintableBankAccount extends BankAccount {
    ...
    private void printInvoice() {
        try {
            ...
            // Sleep here in purpose: to emulate slow operation
            Thread.sleep(1);
 ...
 * Тя работи няколко пъти по-бързо (на моя лаптоп с този вход - около 6 пъти)
